$(function() {
	...
	var submitChat = function() {
		...
		updateChat(you, input);
	        ...
	        // This is replay from Lex, callback may or might not have been called yet as JS asynchronous
	    	var lexResp = bot.respondTo(input);
		...
		waiting++;
	        setTimeout( function() {
		        ...
		        // Extract the reply string from Lex
		        reply = bot.extractLexAnswer(lexResp);
